...
if (empty($reshook)) {
	...
	if ($action == 'add' && $permissiontoadd) {
		...
		if (!$origin && getDolGlobalString('SHIPMENT_STANDALONE')) {
			...
			$object->weight = GETPOST('weight') == '' ? "NULL" : GETPOSTFLOAT('weight');
			$object->sizeH = GETPOST('sizeH') == '' ? "NULL" : GETPOSTFLOAT('sizeH');
			$object->sizeW = GETPOST('sizeW') == '' ? "NULL" : GETPOSTFLOAT('sizeW');
			$object->sizeS = GETPOST('sizeS') == '' ? "NULL" : GETPOSTFLOAT('sizeS');
